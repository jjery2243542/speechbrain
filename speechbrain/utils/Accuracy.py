...
def MaskedAccuracy(log_probablities, targets, length=None, masked_indices=None):
...
class MaskedAccuracyStats:
    ...
    def append(
        self, log_probabilities, targets, length=None, masked_indices=None
    ):
        ...
        length: tensor
            Length of target (batch_size,).
        """
        numerator, denominator = MaskedAccuracy(
            log_probabilities,
            targets,
            length=length,
